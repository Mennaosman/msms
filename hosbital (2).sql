...
INSERT INTO `patient` (`name`, `id`, `age`, `payment_method`, `relative_relation`, `Patienphone`, `department`, `doctor`, `visitno`) VALUES
('menna', 1234, 55, 'health insurance', 'Himeself', 1201415199, 'Clinics', 'Ali ebrahim (surgery)', 0);
